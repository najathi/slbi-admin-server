                            ...
                            <div class="col-md-6 mt-5 mb-3">
                                <div class="card">
                                    <div class="seo-fact sbg1">
                                        ...
                                        <?php
                                        $sqlCountUser = "SELECT U_ID FROM users_acc";
                                        $resultCountUser = mysqli_query($conn, $sqlCountUser);
                                        $rowCountUser = mysqli_num_rows($resultCountUser);
                                        ?>

                                        <div class="p-4 d-flex justify-content-between align-items-center">
                                            <div class="seofct-icon"><i class="fa fa-user-secret"></i> Users</div>
                                            <h2>
                                                <?php 
                                                    printf("%d", $rowCountUser); 
                                                ?>
                                            </h2>
                                        </div>
                            ...
                            <div class="col-md-6 mt-md-5 mb-3">
                                <div class="card">
                                    <div class="seo-fact sbg2">
                                        ...
                                        <?php
                                        $sqlCountSim = "SELECT id FROM sim_details";
                                        $resultCountSim = mysqli_query($conn, $sqlCountSim);
                                        $rowCountSim = mysqli_num_rows($resultCountSim);
                                        ?>

                                        <div class="p-4 d-flex justify-content-between align-items-center">
                                            <div class="seofct-icon"><i class="fa fa-users"></i> Sim Details</div>
                                            <h2><?php printf("%d", $rowCountSim); ?></h2>
                                        </div>
