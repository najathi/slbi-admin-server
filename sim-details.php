        ...
        <div class="main-content">
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Sim Details</h4>
                            <ul class="breadcrumbs pull-left">
                                <li><a href="/">Home</a></li>
                                <li><span>Add or Search Sim Details</span></li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="main-content-inner">
                ...
                <div class="col-12 mt-5">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="header-title">Sim Details</h4>

                            <div class="form-group">
                                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#add_sim_details" title="Add Reciept">
                            ...
                            <div class="single-table">
                                <div class="table-responsive">
                                    ...
                                    <table style="width:100%" id="sim-details-table" class="table table-hover progress-table text-center">
                                    ...
                                    <!-- Add Receipt Model -->
                                    <div class="modal fade bd-example-modal-lg" id="add_sim_details" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog modal-lg" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLabel">Add Sim Details</h5>
                                                ...
                                                <div class="modal-body">
                                                    <form method="post" id="insert_form" enctype="multipart/form-data">
                                                        ...
                                                        <div class="form-group">
                                                            <label for="address_l_one">Address</label>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" placeholder="District" required name="district" id="district">
                                                        </div>
                                                        <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" placeholder="Provided Sim Serial number" required name="sim_s_no" id="sim_s_no">
                                                        </div>
                                                </div>
                                    ...
                                    <!-- Large modal -->
                                    <div id="viewData" class="modal fade view_sim_details">
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title">View - Sim Details</h5>
                                                    <button type="button" class="close" data-dismiss="modal"><span>&times;</span></button>
                                                </div>
                                                <div class="modal-body" id="sim_details_view">
                                                </div>
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                                </div>
                                    ...
                                    <!-- Edit Receipt Model -->
                                    <div class="modal fade bd-example-modal-lg" id="edit_sim_details" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog modal-lg" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLabel">Edit Sim Details</h5>
                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                        <span aria-hidden="true">&times;</span>
                                                    </button>
                                                </div>
                                                <div class="modal-body">
                                                    <form method="post" id="update_form" enctype="multipart/form-data">
                                                        <div class="form-group">
                                                            <label for="id">Sim Details ID</label>
                                                            <input type="text" class="form-control" required name="id" id="id" readonly>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="e_namee">Full Name</label>
                                                        ...
                                                        <div class="form-group">
                                                            <label for="e_nic_no">NIC No</label>
                                                        ...
                                                        <div class="form-group">
                                                            <label for="e_m_no">Mobile Number</label>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="tel" class="form-control" placeholder="Provided Sim Number" required name="e_sim_no" id="e_sim_no">
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="e_sim_s_no">Provided Sim Serial number</label>
                                                            <input type="text" class="form-control" placeholder="Provided Sim Serial number" required name="e_sim_s_no" id="e_sim_s_no">
                                                        </div>
                                                </div>
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#insert_form').on("submit", function(event) {
                ...
                $.ajax({
                    url: "includes/sim-details/sim-details-insert.inc.php",
                    type: "POST",
            ...
            $(document).on('click', '.editBtn', function() {
                var id = $(this).attr("id");
                $.ajax({
                    url: "includes/sim-details/fetch_edit_sim_details.inc.php",
                    type: "POST",
                    data: {
                        id: id
                    },
            ...
            $('#update_form').on("submit", function(event) {
                event.preventDefault();
                $.ajax({
                    url: "includes/sim-details/sim-details-edit.inc.php",
                    type: "POST",
                    data: new FormData(this),
                    cache: false,
                    processData: false,
            ...
            $(document).on('click', '.viewBtn', function() {
                ...
                if (id != '') {
                    $.ajax({
                        url: "includes/sim-details/select-sim-details.inc.php",
                        method: "POST",
                        data: {
                            id: id
                        },
                        success: function(data) {
                            $('#sim_details_view').html(data);
                            $('#viewData').modal('show');
                        }
                    });
                }
            ...
            $(document).on('click', '.delete', function() {
                ...
                if (confirm("Are you sure you want to delete this?")) {
                    $.ajax({
                        url: "includes/sim-details/delete-sim-details.inc.php",
                        method: "POST",
                        data: {
                            id: id
                        },
            ...
            // data table
            var dataTable = $('#sim-details-table').DataTable({
                language: {
                ...
                "autoWidth": false,
                "ajax": {
                    url: "includes/sim-details/fetch-sim-details.inc.php",
                    type: "POST"
                },
                "columnDefs": [{
                    "targets": [0, 6, 7],
