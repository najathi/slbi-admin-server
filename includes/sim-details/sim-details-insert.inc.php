...
if (!empty($_POST)) {
  ...
  $query = "
    INSERT INTO sim_details(namee, address_l_one, address_l_two, nic_no, nic_f_img, nic_b_img, m_no, designation, gn_div, ds_div, district, sim_no, sim_s_no, user_id)  
     VALUES('$namee', '$address_l_one', '$address_l_two', '$nic_no', '$nic_f_fileNameFull', '$nic_b_fileNameFull', '$m_no', '$designation', '$gn_div', '$ds_div', '$district', '$sim_no', '$sim_s_no', '$user_id')";

   if (mysqli_query($conn, $query)) {
    $output .= '<label class="text-success">Data Inserted</label>';
    $select_query = "SELECT * FROM sim_details ORDER BY id DESC";
