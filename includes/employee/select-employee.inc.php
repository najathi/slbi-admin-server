        ...
        <div class="card">
              ...
              <div class="row">
                <div class="col-md-6 text-center m-auto">
                    <img src="../assets/images/emp-photo/employees' . $row["pass_img"] . '" width="200px" height="200px" class="img-fluid mt-3">
              ...
              <div class="collapse show" data-parent="#accordion1">
                    ...
                    <div class="row">
                        <div class="col-md-6 text-center">
                            <img src="../assets/images/emp-photo/employees' . $row["nic_f_img"] . '" width="250px" height="250px" class="img-fluid mt-3">
                            <p class="mb-3 card-text">NIC Front Image</p>
                        </div>
                        <div class="col-md-6 text-center mb-3 img-fluid">
                            <img src="../assets/images/emp-photo/employees' . $row["nic_b_img"] . '" width="250px" height="250px" class="img-fluid mt-3">
